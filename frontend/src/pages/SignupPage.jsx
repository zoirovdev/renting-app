...
const SignupPage = () => {
    ...
    return (
        <div className="flex justify-center items-center pt-[100px]">
            <div className="w-[600px] shadow-md border border-gray-100 rounded-[10px] py-4 px-6 space-y-4 ">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <button 
                        className="bg-lime-400 hover:bg-lime-500 cursor-pointer py-2 px-4 rounded-[10px]"
