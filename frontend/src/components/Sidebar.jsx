            ...
            <div className="flex flex-row justify-center items-center dark:bg-slate-900">
                ...
                <div className='flex justify-center items-center bg-gray-100 rounded-xl p-1 dark:bg-slate-800
                    ...
                    <div className={`text-medium flex justify-center items-center gap-2 cursor-pointer rounded-xl
                        py-2 px-4
                        ${page === "/" ? "bg-white dark:bg-slate-600 dark:text-slate-50 shadow-xl" : "text-gray-500 dark:text-slate-300"}`}
                        onClick={() => {navigate("/");}}>
                    ...
                    <div className={`text-medium flex justify-center items-center gap-2 cursor-pointer rounded-xl
                        py-2 px-4
                        ${page === "/search" ? "bg-white dark:bg-slate-600 dark:text-slate-50 shadow-xl" : "text-gray-500 dark:text-slate-300"}`}
                    ...
                    <div className={`text-medium flex justify-center items-center gap-2 cursor-pointer rounded-xl
                        py-2 px-4
                        ${page === "/add" ? "bg-white dark:bg-slate-600 dark:text-slate-50 shadow-xl" : "text-gray-500 dark:text-slate-300"}`}
                ...
                <div className='absolute right-16 top-4 flex justify-center items-center p-1 gap-1'>
                    <Link to={"/profile"} className={`rounded-xl py-2 px-3.5 bg-black dark:bg-slate-700 text-white place-content-center`}>
                        <span className=''>{currentUser?.firstname[0].toUpperCase()}</span>
                    </Link>
                    <Link to={'/settings'} className={`rounded-xl p-2.5 border border-gray-200 dark:border-none dark:bg-slate-800`}>
